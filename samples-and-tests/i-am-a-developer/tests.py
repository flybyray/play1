...
class IamADeveloper(unittest.TestCase):
    ...
    def testSSLConfig(self):
        ...
        edit(app, "conf/application.conf", 232,
             'play.ssl.netty.pipeline = play.server.FlashPolicyHandler,io.netty.handler.codec.http.HttpRequestDecoder,play.server.StreamChunkAggregator,io.netty.handler.codec.http.HttpResponseEncoder,io.netty.handler.codec.http.HttpContentCompressor,io.netty.handler.stream.ChunkedWriteHandler,play.server.ssl.SslPlayHandler')
